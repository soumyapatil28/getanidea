function GetValue()
{
    var myarray= new Array(
        ...
        "An Operation planner for Doctors.",
        "A Calender app for Family Events.", 
        "A To-Do app for Bloggers.",
        ...
        "Re-cycle helper app.",
        "Finished item from refrigerator alert app.",
        "Subscription alert app.",
        "Home security app.",
        "Referral app.",
        "Equipment Managment app.",
